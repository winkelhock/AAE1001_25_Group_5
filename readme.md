...
|--------------------|-----------------------------------------------------------------------|---------------------------------------------------------------------------|-----------------------------------------------------------------------------|-------------------------------------------------------------|
| **A\***            | - Cost function:  f(n) = g(n) + h(n) - Nodes expansion with the lowest f(n) value | - Efficient with good heuristic<br>- Goal-focused<br>- Finds optimal path | - Heuristic-dependent<br>- High memory use<br>- Complex logic               | - Fast (good heuristic)<br>- Slower (poor heuristic)        |
